...
public class Level3 extends BasicGameState {
	...
	public void init(GameContainer gc, StateBasedGame sbg) throws SlickException {
		...
		mangga[0] = new Rectangle(700, 360, MANGGA, MANGGA);
		mangga[1] = new Rectangle(740, 290, MANGGA, MANGGA);
		mangga[2] = new Rectangle(680, 230, MANGGA, MANGGA);
		mangga[3] = new Rectangle(700, 170, MANGGA, MANGGA);
		mangga[4] = new Rectangle(620, 130, MANGGA, MANGGA);
		mangga[5] = new Rectangle(630, 45, MANGGA, MANGGA);
		mangga[6] = new Rectangle(460, 49, MANGGA, MANGGA);
		mangga[7] = new Rectangle(520, 370, MANGGA, MANGGA);
		mangga[8] = new Rectangle(335, 90, MANGGA, MANGGA);
		mangga[9] = new Rectangle(380, 160, MANGGA, MANGGA);
		mangga[10] = new Rectangle(500, 250, MANGGA, MANGGA);
		mangga[11] = new Rectangle(335, 300, MANGGA, MANGGA);
	}
	...
	public void render(GameContainer gc, StateBasedGame sbg, Graphics g) throws SlickException {
		...
		g.drawString(" 3 ", 94, 13);
		g.drawString(" 12 ", 94, 40);
