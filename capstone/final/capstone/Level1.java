...
public class Level1 extends BasicGameState {
	...
	public void init(GameContainer gc, StateBasedGame sbg) throws SlickException {
		...
		mangga[0] = new Rectangle(355, 120, MANGGA, MANGGA);
		mangga[1] = new Rectangle(320, 280, MANGGA, MANGGA);
		mangga[2] = new Rectangle(435, 175, MANGGA, MANGGA);
		mangga[3] = new Rectangle(500, 295, MANGGA, MANGGA);
		mangga[4] = new Rectangle(690, 175, MANGGA, MANGGA);
		mangga[5] = new Rectangle(620, 45, MANGGA, MANGGA);
		mangga[6] = new Rectangle(475, 160, MANGGA, MANGGA);
		mangga[7] = new Rectangle(510, 250, MANGGA, MANGGA);
		mangga[8] = new Rectangle(515, 335, MANGGA, MANGGA);
		mangga[9] = new Rectangle(480, 85, MANGGA, MANGGA);
		mangga[10] = new Rectangle(565, 180, MANGGA, MANGGA);
		mangga[11] = new Rectangle(600, 275, MANGGA, MANGGA);
...
//		 g.drawString("DEMO PLAY STATE" + "\nTIME " + time + "\nX: " + juanX +
//		 " \nY: " + juanY + "\nMouse X: "
//		 + Mouse.getX() + "\nMouse Y: " + (510 - Mouse.getY()) + "\nORIGIN: "
//		 + "(" + originX + ", " + originY
//		 + ")" + "\nANGLE: " + Math.toDegrees(angle) + "\nHEIGHT: " +
//		 heightMouse + "\nBASE: " + baseMouse
//		 + "\nCOUNT: " + count
//		 +"\nTURNS LEFT: " + turns, 100, 70);
		...
		g.drawString(" 1 ", 94, 13);
		g.drawString(" 8 ", 94, 40);
